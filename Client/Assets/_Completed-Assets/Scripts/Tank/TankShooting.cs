...
namespace Complete
{
    public class TankShooting : MonoBehaviour
    {
        ...
        private void Fire ()
        {
            ...
            OnShoot("Shell", m_FireTransform.position, m_FireTransform.rotation, m_CurrentLaunchForce * m_FireTransform.forward);

            // Reset the launch force.  This is a precaution in case of missing button events.
            m_CurrentLaunchForce = m_MinLaunchForce;
        }

        public Task OnShoot(string shellResource, Vector3 position, Quaternion rotation, Vector3 velocity)
        {
            Debug.Log("OnShoot");
